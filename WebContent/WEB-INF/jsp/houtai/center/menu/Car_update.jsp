...
<body>
		...
		<form id="form1">
				<table style="margin: auto;">
					...
					<tr>
						<td>变速箱类型：</td>
						<td><input type="text" class="form-control input-sm"
							id="cType_Gearbox" name="cType_Gearbox"
							value="${men.cType_Gearbox}"></td>
					</tr>
					<tr>
						<td>档位个数(个)：</td>
						<td><input type="text" class="form-control input-sm"
					...
					<tr>
						<td>油耗：</td>
						<td><input type="text" class="form-control input-sm"
							id="cOil" name="cOil" value="${men.cOil}"></td>
					</tr>
					<tr>
						<td>燃烧形式：</td>
						<td><input type="text" class="form-control input-sm"
					...
					<tr>
						<td>燃油编号：</td>
						<td><input type="text" class="form-control input-sm"
							id="cFuel_Numbert" name="cFuel_Number"
					...
					<tr>
						...
						<td><input class="form_datetime form-control" type="text"
							value="2016-03-07" size="16" name="cTime_Market"
							value="${men.cTime_Market}"></td>
					</tr>
					<tr>
						<td>变速箱：</td>
						<td><input type="text" class="form-control input-sm"
							id="cTransmission" name="cTransmission"
							value="${men.cTransmission}"></td>
					</tr>
					<tr>
						<td>车颜色：</td>
						<td><input type="text" class="form-control input-sm"
							id="cColor" name="cColor" value="${men.cColor}"></td>
					</tr>
					<tr>
						<td>轴距（mm）：</td>
						<td><input type="text" class="form-control input-sm"
							id="cWheelbase" name="cWheelbase" value="${men.cWheelbase}"></td>
					</tr>
					<tr>
						<td>油箱容积：</td>
						<td><input type="text" class="form-control input-sm"
					...
					<tr>
						<td>质保：</td>
						<td><input type="text" class="form-control input-sm"
							id="cVehicle_warranty" name="cVehicle_warranty"
							value="${men.cVehicle_warranty}"></td>
					</tr>
					<tr>
						<td>进气形式：</td>
						<td><input type="text" class="form-control input-sm"
					...
					<tr>
						<td>气缸数(个)：</td>
						<td><input type="text" class="form-control input-sm"
							id="cNumber_Cylinders" name="cNumber_Cylinders"
							value="${men.cNumber_Cylinders}"></td>
					</tr>
					<tr>
						<td>最大马力（Ps）：</td>
						<td><input type="text" class="form-control input-sm"
							id="cMaximum_Horsepower" name="cMaximum_Horsepower"
							value="${men.cMaximum_Horsepower}"></td>
					</tr>
					<tr>
						<td>最大功率（kw）：</td>
						<td><input type="text" class="form-control input-sm"
	...
	<div class="modal-footer">
		<button type="button" class="btn btn-primary" data-dismiss="modal"
			onclick="javascript:car.update()">保存</button>
